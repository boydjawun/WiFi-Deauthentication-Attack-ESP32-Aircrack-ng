...
# Demonstration off DP
> You can watch the ESP32 webpage update in real time as the device disconnects from the network and the LED light won't flash anymore. This link will take you to "Simple Electronics Tutorials" Youtube channel to view the demonstration of the project
